...
const COURSE_DESCRIPTIONS: Record<string, string> = {
  diffEq: "Required by GT (all engineering) and most UIUC engineering majors. Equiv. MATH 2552 at GT / MATH 285 at UIUC.",
  linAlg: "Required by GT ALL College of Engineering and most Science majors, and UIUC CS. Equiv. MATH 1554 at GT / MATH 257 at UIUC.",
  discreteStructures: "Required by UIUC CS, CS+Physics. Equiv. CS 173 at UIUC.",
  chem2: "Required by GT ChBE, Biochemistry, Chemistry; UW-Madison BME, ChemE, MatSci; and several UIUC majors.",
  ...
  compSci1: "Required by GT CompE, CS, Computational Media, Discrete Math; UIUC CompE, CS; UT Austin ECE, ME, Computational Eng. Recommended (not required) by GT engineering majors such as AE, EE, ME, IE. Equiv. CS 1301 at GT / CS 124 at UIUC.",
  compSci2: "Required by GT CompE, CS, Computational Media, Discrete Math; UIUC CS. Equiv. CS 128 at UIUC.",
  computing: "Required by UIUC ME, AE, CE, IE, Physics, SE&D, etc.; UT Austin ECE, ME, Computational Eng. Equiv. CS 101/124/SE 101/ME 170 at UIUC; CS 303E or CS 312 at UT Austin.",
  ...
  labSciElective: "Required by GT CompE, EE, IE, ME, CS, and most College of Design/Liberal Arts majors; also UT Austin (select majors). Any one lab science course (biology, chemistry, calculus-based physics, earth & atmospheric science) with lecture and lab.",
